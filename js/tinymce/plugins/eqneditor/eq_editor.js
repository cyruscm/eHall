...
var EqEditor = {
    ...
    Example: {
        ...
        show: function(button, group) {
            ...
            EqnEditor.Gallery = new Scroll();
            if (group == 'fav' || group == 'history') {
                var d = new Date();
                EqnEditor.Gallery.init('photos', 'leftarrow', 'rightarrow', 'overview', FAVORITE_ENGINE + '/example_json.php?fn=gallery&rand=' + d.getTime() + '&sid=' + EqEditor.SID);
            } else EqnEditor.Gallery.init('photos', 'leftarrow', 'rightarrow', 'overview', FAVORITE_ENGINE + '/example_json.php?fn=gallery');
            EqnEditor.Gallery.visible_num = 1;
            EqnEditor.Gallery.new_offset = 5;
            EqnEditor.Gallery.maxpanels = 1;
            EqnEditor.Gallery.set_width(600, 100, 60);
            EqnEditor.Gallery.set_subtext('&type=' + group);
            EqnEditor.Gallery.add_panel();
            EqnEditor.Gallery.setarrow();
            EqnEditor.Gallery.setoverview();
        },
        hide: function() {
